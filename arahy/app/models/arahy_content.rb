class ArahyContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :arahy_resource
  has_one     :arahy_genome_summary
  has_one     :arahy_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :arahy_genome_summary_attributes, :arahy_selected_reference_attributes

  accepts_nested_attributes_for :arahy_selected_reference,
    :arahy_genome_summary, :update_only => true
