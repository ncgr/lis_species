...
describe ArahyContentsController do
  
  def mock_arahy_content(stubs={})
    @mock_arahy_content ||= mock_model(ArahyContent, stubs).as_null_object
  end
  ...
  describe "GET index without logging in" do
    before(:each) do
      @arahy = Factory.build(:arahy_content)
    end
  ...
  describe "GET edit and PUT update arahy_content while logged in as superuser" do
    login_superuser
    before(:each) do
      @arahy = Factory.build(:arahy_content)
      ArahyContent.should_receive(:find).with("21").and_return(@arahy)
    end
    it "should find arahy_content and return object" do
      get :edit, :id => "21"
      response.should render_template('edit')
    end
    it "should update object" do
      put :update, :id => "21", :arahy_content => {}
      response.should be_redirect
    end
  end
  
  describe "GET edit and PUT update arahy_content while logged in as admin" do
    login_admin
    before(:each) do
      @arahy = Factory.build(:arahy_content)
      ArahyContent.should_receive(:find).with("212").and_return(@arahy)
    end
    it "should find arahy_content and return object" do
      get :edit, :id => "212"
      response.should render_template('edit')
    ...
    it "should update object" do
      put :update, :id => "212", :arahy_content => {}
      response.should be_redirect
    end
  end
