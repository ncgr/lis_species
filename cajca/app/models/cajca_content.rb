class CajcaContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :cajca_resource
  has_one     :cajca_genome_summary
  has_one     :cajca_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :cajca_genome_summary_attributes, :cajca_selected_reference_attributes

  accepts_nested_attributes_for :cajca_selected_reference,
    :cajca_genome_summary, :update_only => true
