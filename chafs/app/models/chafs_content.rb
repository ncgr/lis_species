class ChafsContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :chafs_resource
  has_one     :chafs_genome_summary
  has_one     :chafs_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :chafs_genome_summary_attributes, :chafs_selected_reference_attributes

  accepts_nested_attributes_for :chafs_selected_reference,
    :chafs_genome_summary, :update_only => true
