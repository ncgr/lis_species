...
class CicarContentsController < ApplicationController
  ...
  def edit
    @content = CicarContent.find(params[:id])
  end

  def update
    params[:cicar_content][:existing_pathogens_attributes] ||= {}
    params[:cicar_content][:existing_nodulators_attributes] ||= {}
    params[:cicar_content][:existing_reference_datasets_attributes] ||= {}
    params[:cicar_content][:existing_resources_attributes] ||= {}
    ...
    if @content.update_attributes(params[:cicar_content])
