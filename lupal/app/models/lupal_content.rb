class LupalContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :lupal_resource
  has_one     :lupal_genome_summary
  has_one     :lupal_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :lupal_genome_summary_attributes, :lupal_selected_reference_attributes

  accepts_nested_attributes_for :lupal_selected_reference,
    :lupal_genome_summary, :update_only => true
