class LupanContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :lupan_resource
  has_one     :lupan_genome_summary
  has_one     :lupan_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :lupan_genome_summary_attributes, :lupan_selected_reference_attributes

  accepts_nested_attributes_for :lupan_selected_reference,
    :lupan_genome_summary, :update_only => true
