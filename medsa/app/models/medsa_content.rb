class MedsaContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :medsa_resource
  has_one     :medsa_genome_summary
  has_one     :medsa_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :medsa_genome_summary_attributes, :medsa_selected_reference_attributes

  accepts_nested_attributes_for :medsa_selected_reference,
    :medsa_genome_summary, :update_only => true
