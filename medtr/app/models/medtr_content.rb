class MedtrContent < ActiveRecord::Base
  ...
  belongs_to  :user
  belongs_to  :legume
  has_one     :medtr_resource
  has_one     :medtr_genome_summary
  has_one     :medtr_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :medtr_genome_summary_attributes, :medtr_selected_reference_attributes

  accepts_nested_attributes_for :medtr_selected_reference,
    :medtr_genome_summary, :update_only => true
