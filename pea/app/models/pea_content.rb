class PeaContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :pea_resource
  has_one     :pea_genome_summary
  has_one     :pea_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :pea_genome_summary_attributes, :pea_selected_reference_attributes

  accepts_nested_attributes_for :pea_selected_reference,
    :pea_genome_summary, :update_only => true
