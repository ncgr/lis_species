...
describe PeaContentsController do
  ...
  describe "GET edit and PUT update pea_content while logged in as superuser" do
    login_superuser
    before(:each) do
      @pea = Factory.build(:pea_content)
      PeaContent.should_receive(:find).with("21").and_return(@pea)
    end
    it "should find pea_content and return object" do
      get :edit, :id => "21"
      response.should render_template('edit')
    end
    it "should update object" do
      put :update, :id => "21", :pea_content => {}
      response.should be_redirect
    end
  end
  
  describe "GET edit and PUT update pea_content while logged in as admin" do
    login_admin
    before(:each) do
      @pea = Factory.build(:pea_content)
      PeaContent.should_receive(:find).with("212").and_return(@pea)
    end
    it "should find pea_content and return object" do
      get :edit, :id => "212"
      response.should render_template('edit')
