class PhacnContentsController < ApplicationController
  ...
  def edit
    @content = PhacnContent.find(params[:id])
  end

  def update
    params[:phacn_content][:existing_pathogens_attributes] ||= {}
    params[:phacn_content][:existing_nodulators_attributes] ||= {}
    params[:phacn_content][:existing_reference_datasets_attributes] ||= {}
    params[:phacn_content][:existing_resources_attributes] ||= {}
    ...
    if @content.update_attributes(params[:phacn_content])
