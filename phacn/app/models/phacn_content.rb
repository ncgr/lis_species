class PhacnContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :phacn_resource
  has_one     :phacn_genome_summary
  has_one     :phacn_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :phacn_genome_summary_attributes, :phacn_selected_reference_attributes

  accepts_nested_attributes_for :phacn_selected_reference,
    :phacn_genome_summary, :update_only => true
