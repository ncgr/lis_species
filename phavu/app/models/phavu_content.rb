class PhavuContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :phavu_resource
  has_one     :phavu_genome_summary
  has_one     :phavu_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :phavu_genome_summary_attributes, :phavu_selected_reference_attributes

  accepts_nested_attributes_for :phavu_selected_reference,
    :phavu_genome_summary, :update_only => true
