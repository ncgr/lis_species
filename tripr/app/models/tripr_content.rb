class TriprContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :tripr_resource
  has_one     :tripr_genome_summary
  has_one     :tripr_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :tripr_genome_summary_attributes, :tripr_selected_reference_attributes

  accepts_nested_attributes_for :tripr_selected_reference,
    :tripr_genome_summary, :update_only => true
