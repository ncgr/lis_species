class VigraContentsController < ApplicationController
  ...
  def edit
    @content = VigraContent.find(params[:id])
  end

  def update
    params[:vigra_content][:existing_pathogens_attributes] ||= {}
    params[:vigra_content][:existing_nodulators_attributes] ||= {}
    params[:vigra_content][:existing_reference_datasets_attributes] ||= {}
    params[:vigra_content][:existing_resources_attributes] ||= {}
    ...
    if @content.update_attributes(params[:vigra_content])
