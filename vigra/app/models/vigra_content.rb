class VigraContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :vigra_resource
  has_one     :vigra_genome_summary
  has_one     :vigra_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :vigra_genome_summary_attributes, :vigra_selected_reference_attributes

  accepts_nested_attributes_for :vigra_selected_reference,
    :vigra_genome_summary, :update_only => true
