class VigunContent < ActiveRecord::Base

  belongs_to  :user
  belongs_to  :legume
  has_one     :vigun_resource
  has_one     :vigun_genome_summary
  has_one     :vigun_selected_reference
  ...
  attr_accessible :overview, :ncbi_taxon_id, :grin_taxon_id, :special_interest,
    ...
    :vigun_genome_summary_attributes, :vigun_selected_reference_attributes

  accepts_nested_attributes_for :vigun_selected_reference,
    :vigun_genome_summary, :update_only => true
